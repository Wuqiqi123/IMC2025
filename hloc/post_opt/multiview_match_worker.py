...
from hloc.utils.data_io import dict_to_cuda
...
@torch.no_grad()
def matchWorker(colmap_dataset, matcher, subset_track_idxs=None, visualize=False, visualize_dir=None, dataset_cfgs=None, verbose=True):
