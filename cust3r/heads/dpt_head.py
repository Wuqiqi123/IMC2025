...
from cust3r.heads.postprocess import (
    postprocess,
    postprocess_desc,
    postprocess_rgb,
...
from cust3r.utils.camera import PoseDecoder
...
class DPTOutputAdapter_fix(DPTOutputAdapter):
    """
    Adapt croco's DPTOutputAdapter implementation for cust3r:
    remove duplicated weigths, and fix forward for cust3r
    """
...
class PixelwiseTaskWithDPT(nn.Module):
    """DPT module for cust3r, can return 3D points + confidence for all pixels"""
